...
public class FriendDao extends AbstractDao<Friend, Long> {
    ...
    public static class Properties {
        ...
        public final static Property PhotoUrl = new Property(2, String.class, "photoUrl", false, "PHOTO_URL");
    }
    ...
    public Friend readEntity(Cursor cursor, int offset) {
        Friend entity = new Friend( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // photoUrl
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Friend entity, int offset) {
        ...
        entity.setPhotoUrl(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
