...
public class MyView extends View
{
    ...
    public MyView(Context context, AttributeSet attrs) {
        ...
        /*圆环的大小及是否圆角*/
        mStrokeWith = typedArray.getInteger(R.styleable.ColorCircleProgressView_StrokeWith, 50);
        ...
        mPointRaido = typedArray.getInteger(R.styleable.ColorCircleProgressView_PointRadio, 20);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("60",x0,0,mPaint2);
