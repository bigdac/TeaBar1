...
public class ScoreView4 extends View
{
    ...
    public ScoreView4(Context context) {
        super(context);
    }

    public ScoreView4(Context context, AttributeSet attrs) {
        super(context, attrs);
        /*获取属性集合*/
    ...
    private void SetPaint() {
        ...
        mPaint2.setColor(Color.parseColor("#c8a8fb"));
...
//        }
        ...
        canvas.drawArc(rectF, mStartAangle+270 ,mPointAngle, false, mPaint2);
