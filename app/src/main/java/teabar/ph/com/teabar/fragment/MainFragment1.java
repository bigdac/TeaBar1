...
public class MainFragment1 extends BaseFragment  {
    ...
    private void initView1() {
        ...
        TeaFragment teaFragment1 = new TeaFragment();
        TeaFragment teaFragment2 = new TeaFragment();
        fragmentList.add(teaFragment);
        fragmentList.add(teaFragment1);
        fragmentList.add(teaFragment2);

        ClickfragAdapter tabAdapter = new ClickfragAdapter(getActivity().getSupportFragmentManager(), fragmentList, getActivity());
