 ...
 */
public class CircleAdapter3 extends RecyclerView.Adapter<RecyclerView.ViewHolder>   {
    ...
    public CircleAdapter3(Context context , List <CircleItem> list){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == TYPE_HEAD){
            View headView = LayoutInflater.from(context).inflate(R.layout.head_circle1, parent, false);
