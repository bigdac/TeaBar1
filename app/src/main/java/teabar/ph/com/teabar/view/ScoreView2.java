...
public class ScoreView2 extends View
{
    ...
    public ScoreView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void SetPaint() {
        ...
        mPaint2.setColor(Color.parseColor("#8a9cfb"));
...
//        }
        ...
        canvas.drawArc(rectF, mStartAangle  , mPointAngle-90, false, mPaint2);
